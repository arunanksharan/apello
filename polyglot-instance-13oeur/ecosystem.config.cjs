...
module.exports = {
  apps : [{
    ...
    cwd    : "/root/apello/polyglot-instance-13oeur", // Set the Current Working Directory for the process
    ...
    env: {
      "NODE_ENV": "production", // Good practice to set NODE_ENV
      "PORT": "8082"          // Set the port for the agent (or another free port)
    }    
